...
.banner {
  ...
  &:before {
    ...
    height: 100px;
    border-radius: 50%;
    background: linear-gradient(to right, #404349, #000);
    position: absolute;
    right: 400px;
    top: 400px;
    z-index: -99;
...
@media screen and (max-width: 785px) {
  .banner {
    &:after {
      content: "";
      background: linear-gradient(to right, $lighter-bg, $darker-bg);
      position: absolute;
      right: -200px;
      top: -134px;
      box-shadow: -29px 0 29px 1px #404349;
    ...
    &:before {
      ...
      height: 100px;
      border-radius: 50%;
      background: linear-gradient(to left, #404349, $lighter-bg);
      position: absolute;
      right: 400px;
      top: 400px;
      z-index: -9999;
